...
protected:
    ...
    void visit(const DoWhile *op) override {
        internal_assert(false) << "Encounter unexpected statement \"Do\" when differentiating.";
    }
    ...
    void visit(const TensorOp *op) override {
        internal_assert(false) << "Encounter unexpected statement \"TensorOp\" when differentiating.";   
    }
